...
public class TestGetContigOutput{
 public static void main( String[] args) throws Exception{
	 ...
	 File folder = new File("/Users/qiaojixu/Desktop/RACCROCHE/project-monocots/results/InputPyfile/mwmOutput/");
	   for (File afile : folder.listFiles() ) {
		 if ( afile.getName().substring(0,1).equals("W")  ) {
		  int geneNumber = 10279 ;
		  ...
		  String inputFile = "/Users/qiaojixu/Desktop/RACCROCHE/project-monocots/results/InputPyfile/mwmOutput/"+ afile.getName(); 
		  ...
		  String outPutFileName ="/Users/qiaojixu/Desktop/RACCROCHE/project-monocots/data/Contig/Contig" + afile.getName();	
